...
if __name__ == "__main__":
    ...
    if top_n_documents:
        for i, doc in enumerate(top_n_documents):
            ...
            print(f"  Spec Shots: {doc.get('specificShots')}, Movement: {doc.get('movement')}")
            print("-" * 20)
    else:
    ...
    if top_n_documents:
        ...
        fields_to_check = ['type', 'participants', 'squashLevel', 'intensity', 'duration', 'shots', 'shotSide', 'specificShots', 'movement']
